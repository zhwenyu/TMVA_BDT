...
#    infname = "TTTT_TuneCP5_13TeV-amcatnlo-pythia8_hadd.root" # 2018 old
    ...
    for b in bkgFileList:
        ...
        for i in range(len(bkgs)):
            ...
            bkgTreeList[b].append(bkgFileList[b][i].Get("ljmet"))
            if bkgTreeList[b][i].GetEntries() == 0: continue
            loader.AddTree(bkgTreeList[b][i], b)
