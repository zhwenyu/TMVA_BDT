...
{   
   ...
   // Book method(s)
   reader->BookMVA("BDT<Mass> method", <weightFilePathMass> );
   ...
   Float_t BDT<mass>; TBranch *b_BDT<mass> = newTree->Branch("BDT<mass>",&BDT<mass>,"BDT<mass>/F");
   ...
   for (Long64_t ievt=0; ievt<theTree->GetEntries();ievt++) {
      ...
      BDT<mass> = reader->EvaluateMVA( "BDT<mass> method");
